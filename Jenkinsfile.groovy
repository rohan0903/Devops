...
sh label: '', script: 'curl -X PUT -u u:p -T myproject-0.0.1-SNAPSHOT.jar "http://34.248.32.208:8000/artifactory/admin-repositories-local-SpringBoot/myproject-0.0.1-SNAPSHOT.jar"'
}
